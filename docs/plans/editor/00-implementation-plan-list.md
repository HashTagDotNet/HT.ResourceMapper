...
| 8 | **Editor UI — Dependencies / Dependent On** | Searchable resource picker (same-domain only); both directions editable (system writes far side); nested "Create new…" target (domain-locked) with pop-back; persistence timing. | 6, 2 | Planning |
