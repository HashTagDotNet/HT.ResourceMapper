...
| 4 | **Services & API** | `IResourceService`: get / create / update / delete / uniqueness-check; tag-definition CRUD (inline create); relationship CRUD; controllers via `ApiControllerBase`. | 3 | Planning |
