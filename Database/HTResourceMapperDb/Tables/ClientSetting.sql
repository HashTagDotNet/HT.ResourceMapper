-- Generic per-owner settings, keyed by ICurrentIdentity.OwnerId (see design §7.1). First consumer:
...
(
    ...
    ,CONSTRAINT [UK_ClientSetting_Owner_Key] UNIQUE (OwnerId, SettingKey)
)
